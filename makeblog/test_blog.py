...
class TestBlog(TestCase):
    ...
    def test_sortpostsauthor(self):
        ...
        p.blog.authors = [AbstractTestAuthor("nick1"), AbstractTestAuthor("nick2")]
    ...
    def test_countpostsauthor(self):
        ...
        p.blog.authors = [AbstractTestAuthor([0, 1]), AbstractTestAuthor([0, 1, 2])]
        p.run()
